...
# @objective
You read a contest problem correctly: you know what the data is, which metric scores you, what the submission looks like, and what the leaderboard does (and doesn't) tell you.
